...
IDD_QUERYDLG                    equ 102
    ...
    include odbc.inc            ; local includes for this file
	...
	.if ax==SQL_SUCCESS || ax==SQL_SUCCESS_WITH_INFO
		...
		.if ax==SQL_SUCCESS || ax==SQL_SUCCESS_WITH_INFO
			...
			.if ax==SQL_SUCCESS || ax==SQL_SUCCESS_WITH_INFO			
				...
				invoke SQLDriverConnect, hConn, hDlg, addr ConnectString, sizeof ConnectString, addr Conn, sizeof Conn,addr OutStrLen, SQL_DRIVER_COMPLETE
				.if ax==SQL_SUCCESS || ax==SQL_SUCCESS_WITH_INFO					
...
RunQuery proc hDlg:DWORD
      ...
      invoke MessageBox,hDlg,addr SQLStatement, addr AppName, MB_OK
	...
	.if ax==SQL_SUCCESS || ax==SQL_SUCCESS_WITH_INFO
		...
		.if ax==SQL_SUCCESS || ax==SQL_SUCCESS_WITH_INFO
			 fn MsgboxI,hDlg,"QUERY Success",ustr$(eax),MB_OK,500
